      ...
      <div className={s.footerBox}>
        ...
        <div className={s.socialFooter}>
          <div className={s.links}>
            <Link className={s.AA} to={'/'}>
              main
            </Link>
            <span className={s.dot2}>·</span>
            <Link className={s.AA} to={'/skils'}>
              feat/skills
            </Link>
            <span className={s.dot3}>·</span>
            <Link className={s.AA} to={'/project'}>
              release/projects
            </Link>
            <span className={s.dot2}>·</span>
            <div className={s.resume}>
              <span className={s.soctag}>
                <MdFileDownload size={21} />
              </span>{' '}
              <a href="">resume</a>
            </div>
          </div>
        ...
        <div className={s.time}>
          <div className={s.TimeCountry}>
            <span className={s.icon}>
              {' '}
              <Clock size={20} />
            </span>
            <span className={s.Country}>Time in Ukraine</span>
          </div>
          <div className={s.gg}>
