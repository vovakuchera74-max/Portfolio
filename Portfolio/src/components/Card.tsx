 ...
 const date = new Date(repo.updated_at).toISOString().split('T')[0];
    ...
    return(
            ...
            <div className={s.Cardtop}>
                <div className={s.some}>
                    ...
                    <div className={s.starBlock}>
                        <span className={s.star}><MdOutlineStar /></span>
                ...
                <div className={s.Linkk}>
                    <a href={repo!.homepage} className={s.link} target="_blank">Preview</a>
                    <a href={repo.html_url} className={s.link} target="_blank">Github</a>
                </div>
        ...
        <div className={s.tags}>
          <span className={s.icon11}><GoTag /></span>
