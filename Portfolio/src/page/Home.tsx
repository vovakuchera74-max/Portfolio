      ...
      <div className={s.left}>
        <div className={s.leftBlock}>
          ...
          <div className={s.info}>
            I'm a 18 year old web developer from Ukraine, Ivano-Frankivsk.I
            Specializing in building modern, accessible, and high-performing web
            applications with{' '}
          ...
          <div className={s.lansuages}>
            <div className={s.lansuagesWord}>Languages: </div>{' '}
            <div className={s.lansuage}>
              <span className={s.words}>English</span>
            </div>{' '}
            <div className={s.lansuage}>
              <span className={s.words}>Ukraine</span>
            </div>
          </div>
